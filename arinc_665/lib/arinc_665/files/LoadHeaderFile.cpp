...
void LoadHeaderFile::processLoadCrc( Helper::ConstRawDataSpan rawFile, Arinc649::Arinc649Crc32 &loadCrc )
{
...
void LoadHeaderFile::encodeLoadCheckValue( Helper::RawDataSpan rawFile, const Arinc649::CheckValue &checkValue )
{
  if ( loadFileFormatVersion( rawFile ) != LoadFileFormatVersion::Version345 )
  {
...
Arinc649::CheckValue LoadHeaderFile::decodeLoadCheckValue( Helper::ConstRawDataSpan rawFile )
{
  if ( loadFileFormatVersion( rawFile ) != LoadFileFormatVersion::Version345 )
  {
    return Arinc649::CheckValue::NoCheckValue;
  }
...
Arinc649::CheckValueType LoadHeaderFile::loadCheckValueType() const
{
  return loadCheckValueTypeV;
}

void LoadHeaderFile::loadCheckValueType( const Arinc649::CheckValueType type )
{
...
void LoadHeaderFile::decodeBody( Helper::ConstRawDataSpan rawFile )
{
  ...
  loadCheckValueTypeV = Arinc649::CheckValueType::NotUsed;
