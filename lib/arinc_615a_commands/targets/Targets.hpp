 ...
 *
 * @brief Declaration of Namespace Arinc615aCommands::Targets.
 **/

/**
 * @dir
 * @brief Declaration/ Definition of Namespace Arinc615aCommands::Targets.
 **/

#ifndef ARINC_615A_COMMANDS_TARGETS_TARGETS_HPP
#define ARINC_615A_COMMANDS_TARGETS_TARGETS_HPP
 ...
 * - @ref FindQueryCommand
 * - @ref ListTargetsCommand
 **/
namespace Arinc615aCommands::Targets {

/**
 * @brief Registers the ARINC 615A Targets %Commands to the Registry.
 *
