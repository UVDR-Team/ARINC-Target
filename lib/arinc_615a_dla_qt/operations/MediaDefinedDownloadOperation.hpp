...
#ifndef ARINC_615A_DLA_QT_OPERATIONS_MEDIADEFINEDDOWNLOADOPERATION_HPP
#define ARINC_615A_DLA_QT_OPERATIONS_MEDIADEFINEDDOWNLOADOPERATION_HPP
...
/**
 * @brief ARINC 615A Media Defined Download Operation.
 *
 * This class wraps the ARINC 615A Operation and converts callbacks into Qt signals.
 **/
class ARINC_615A_DLA_QT_EXPORT MediaDefinedDownloadOperation final :
  public QObject,
  private Arinc615a::Host::MediaDefinedDownloadOperationHandler
{
  ...
  public slots:
     ...
     */
    void transmitFiles( const Arinc615a::Information::DownloadFiles files, Helper::RawData userDefinedData );
