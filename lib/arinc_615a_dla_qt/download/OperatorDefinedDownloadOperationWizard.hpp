 ...
 *
 * @brief Declaration of Class Arinc615aDlaQt::OperatorDefinedDownloadOperationWizard.
 **/

#ifndef ARINC_615A_DLA_QT_DOWNLOAD_OPERATORDEFINEDDOWNLOADOPERATIONWIZARD_HPP
#define ARINC_615A_DLA_QT_DOWNLOAD_OPERATORDEFINEDDOWNLOADOPERATIONWIZARD_HPP
...
namespace Ui {
class OperatorDefinedDownloadOperationWizard;
}

/**
 * @brief ARINC 615A Operator Defined Download Operation Wizard.
 **/
class ARINC_615A_DLA_QT_EXPORT OperatorDefinedDownloadOperationWizard final : public QWizard
{
    Q_OBJECT
  ...
  public:
     ...
     *   Parent Widget
     **/
    explicit OperatorDefinedDownloadOperationWizard(
    ...
    //! Destructor
    ~OperatorDefinedDownloadOperationWizard() override;
  ...
  private slots:
    ...
    /**
     * @brief Slot called, when the create download subdirectory option has changed.
     *
    ...
    /**
     * @brief Slot called, when user has finished selection
     **/
    void filesSelected();
  ...
  private:
    ...
    std::unique_ptr< Ui::OperatorDefinedDownloadOperationWizard > uiV;

    //! ARINC 615A Operator Defined Download Operation
    std::unique_ptr< OperatorDefinedDownloadOperation > operationV;
