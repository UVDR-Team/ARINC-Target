...
BOOST_AUTO_TEST_CASE( getInt8BigEndianTest )
{
  ...
  BOOST_CHECK_THROW(
    boost::ignore_unused( RawData_getInt< uint8_t >( ArincSupport::ConstRawDataSpan{}, boost::endian::order::big ) ),
    std::out_of_range );
}
...
BOOST_AUTO_TEST_CASE( getInt8LittleEndianTest )
{
  ...
  BOOST_CHECK_THROW(
    boost::ignore_unused( RawData_getInt< uint8_t >( ArincSupport::ConstRawDataSpan{}, boost::endian::order::little ) ),
    std::out_of_range );
}
...
BOOST_AUTO_TEST_CASE( getInt16BigEndianTest )
{
  ...
  BOOST_CHECK_THROW(
    boost::ignore_unused( RawData_getInt< uint16_t >( ArincSupport::ConstRawDataSpan{}, boost::endian::order::big ) ),
    std::out_of_range );
}
...
BOOST_AUTO_TEST_CASE( getInt16LittleEndianTest )
{
  ...
  BOOST_CHECK_THROW(
    boost::ignore_unused( RawData_getInt< uint16_t >( ArincSupport::ConstRawDataSpan{}, boost::endian::order::little ) ),
    std::out_of_range );
}
...
BOOST_AUTO_TEST_CASE( getInt32BigEndianTest )
{
  ...
  BOOST_CHECK_THROW(
    boost::ignore_unused( RawData_getInt< uint32_t >( ArincSupport::ConstRawDataSpan{}, boost::endian::order::big ) ),
    std::out_of_range );
}
...
BOOST_AUTO_TEST_CASE( getInt32BigLittleTest )
{
  ...
  BOOST_CHECK_THROW(
    boost::ignore_unused( RawData_getInt< uint32_t >( ArincSupport::ConstRawDataSpan{}, boost::endian::order::little ) ),
    std::out_of_range );
}
...
BOOST_AUTO_TEST_CASE( getInt64BigEndianTest )
{
  ...
  BOOST_CHECK_THROW(
    boost::ignore_unused( RawData_getInt< uint64_t >( ArincSupport::ConstRawDataSpan{}, boost::endian::order::big ) ),
    std::out_of_range );
}
...
BOOST_AUTO_TEST_CASE( getInt64BigLittleTest )
{
  ...
  BOOST_CHECK_THROW(
    boost::ignore_unused( RawData_getInt< uint64_t >( ArincSupport::ConstRawDataSpan{}, boost::endian::order::little ) ),
    std::out_of_range );
}
