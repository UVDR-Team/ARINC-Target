 ...
 *
 * @brief Definition of Class Arinc615aQt::DownloadStatusLogModel.
 **/

#include "DownloadStatusLogModel.hpp"
...
DownloadStatusLogModel::DownloadStatusLogModel( QObject * const parent ) : QAbstractTableModel{ parent }
{
}

DownloadStatusLogModel::~DownloadStatusLogModel() = default;

int DownloadStatusLogModel::rowCount( const QModelIndex &parent ) const
{
  if ( parent.isValid() )
  {
    return 0;
...
int DownloadStatusLogModel::columnCount( const QModelIndex &parent ) const
{
  if ( parent.isValid() )
  {
    return 0;
...
QVariant DownloadStatusLogModel::data( const QModelIndex &index, const int role ) const
{
  if ( !index.isValid() )
  {
    return {};
...
QVariant DownloadStatusLogModel::headerData(
  const int section,
...
const DownloadStatusLogModel::DownloadStatusLog& DownloadStatusLogModel::statusLog() const
{
  return statusLogV;
}

Arinc615a::Information::DownloadStatus DownloadStatusLogModel::status( const QModelIndex &index ) const
{
  if ( !index.isValid() )
  {
    return {};
...
void DownloadStatusLogModel::status( const Arinc615a::Information::DownloadStatus &status )
{
