...
class TFTP_EXPORT MemoryFile final : public File
{
  public:
     ...
     *   Initial data.
     **/
    explicit MemoryFile( ArincSupport::ConstRawDataSpan data );
     ...
     *   Data of memory file.
     **/
    explicit MemoryFile( ArincSupport::RawData data );
     ...
     **/
    [[nodiscard]] ArincSupport::ConstRawDataSpan data() const noexcept;
     ...
     **/
    void receivedData( ArincSupport::ConstRawDataSpan data ) override;
     ...
     **/
    [[nodiscard]] ArincSupport::RawData sendData( size_t maxSize ) override;

  private:
    //! Operation Type
    const Operation operationV;
    //! Data
    ArincSupport::RawData dataV;
    //! Current Read Position
    ArincSupport::RawData::const_iterator dataPtr;
};
