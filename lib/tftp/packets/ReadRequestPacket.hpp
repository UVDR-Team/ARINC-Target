 ...
 **/
class TFTP_EXPORT ReadRequestPacket final : public ReadWriteRequestPacket
{
  public:
    /**
     ...
     **/
    explicit ReadRequestPacket( ArincSupport::ConstRawDataSpan rawPacket );
     ...
     * @return *this
     **/
    ReadRequestPacket& operator=( ArincSupport::ConstRawDataSpan rawPacket );
};
