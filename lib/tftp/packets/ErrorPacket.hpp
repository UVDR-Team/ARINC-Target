...
class TFTP_EXPORT ErrorPacket final : public Packet
{
  public:
     ...
     **/
    explicit ErrorPacket( ArincSupport::ConstRawDataSpan rawPacket );
     ...
     * @return *this
     **/
    ErrorPacket& operator=( ArincSupport::ConstRawDataSpan rawPacket );
    ...
    /**
     * @brief Returns the error information of this packet.
     *
     * The error information is always valid (i.e. contains a value).
     *
     * @return TFTP error information
     **/
    [[nodiscard]] ErrorInformation errorInformation() const;
  ...
  private:
     ...
     **/
    void decodeBody( ArincSupport::ConstRawDataSpan rawPacket );

    //! Error Code.
    ErrorCode errorCodeV{ ErrorCode::Invalid };
    //! Error Message.
