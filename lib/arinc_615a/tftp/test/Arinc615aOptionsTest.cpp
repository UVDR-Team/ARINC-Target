...
{
  BOOST_CHECK( Arinc615aOptions_name( ArincChecksum::CheckValueType::Crc8 ) == "checksum_1" );
  BOOST_CHECK( Arinc615aOptions_name( ArincChecksum::CheckValueType::Crc16 ) == "checksum_2" );
  BOOST_CHECK( Arinc615aOptions_name( ArincChecksum::CheckValueType::Crc32 ) == "checksum_3" );
  BOOST_CHECK( Arinc615aOptions_name( ArincChecksum::CheckValueType::Md5 ) == "checksum_4" );
  BOOST_CHECK( Arinc615aOptions_name( ArincChecksum::CheckValueType::Sha1 ) == "checksum_5" );
  BOOST_CHECK( Arinc615aOptions_name( ArincChecksum::CheckValueType::Sha256 ) == "checksum_6" );
  BOOST_CHECK( Arinc615aOptions_name( ArincChecksum::CheckValueType::Sha512 ) == "checksum_7" );
  BOOST_CHECK( Arinc615aOptions_name( ArincChecksum::CheckValueType::Crc64 ) == "checksum_8" );

  // NOLINTNEXTLINE( clang-analyzer-optin.core.EnumCastOutOfRange ): Test
  BOOST_CHECK( Arinc615aOptions_name( ArincChecksum::CheckValueType{ 99 } ).empty() );
}
...
BOOST_AUTO_TEST_CASE( checksumTarget )
{
  ...
  BOOST_CHECK( std::make_pair( true, ArincChecksum::CheckValue{} ) == Arinc615aOptions_checksum( optionsEmpty ) );
  ...
  BOOST_CHECK(
    std::make_pair(
      true,
      ArincChecksum::CheckValue{ ArincChecksum::CheckValueType::Crc8, std::vector< std::byte >{ 0x00_b, 0x01_b } } )
  ...
  BOOST_CHECK( std::make_pair( false, ArincChecksum::CheckValue{} ) == Arinc615aOptions_checksum( options4 ) );
  ...
  BOOST_CHECK( std::make_pair( false, ArincChecksum::CheckValue{} ) == Arinc615aOptions_checksum( options5 ) );
}
