...
BOOST_AUTO_TEST_CASE( asStringTest )
{
  ...
  BOOST_CHECK( RawData_asString( Helper::RawData_asRaw( "TEST" ) ) == "TEST" );
}

//! Raw Data as String representation
BOOST_AUTO_TEST_CASE( asStringTestWithLength )
{
  BOOST_CHECK( RawData_asString( Helper::RawData_asRaw( "TEST" ), 0 ).empty() );
  BOOST_CHECK( RawData_asString( Helper::RawData_asRaw( "TEST" ), 2 ) == "TE" );
  BOOST_CHECK( RawData_asString( Helper::RawData_asRaw( "TEST" ), 4 ) == "TEST" );
}
