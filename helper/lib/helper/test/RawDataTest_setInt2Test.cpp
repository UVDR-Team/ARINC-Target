...
BOOST_AUTO_TEST_SUITE( RawData_setInt2Test )
...
BOOST_AUTO_TEST_CASE( setInt8BigEndianTest )
{
  ...
  const auto retData{ RawData_setInt< uint8_t >( data, 0x01, boost::endian::order::big ) } ;
  BOOST_CHECK( retData.empty() );
  BOOST_CHECK( std::ranges::equal( data, RawData_asRawData( std::to_array< uint8_t >( { 0x01 } ) ) ) );

  BOOST_CHECK_THROW( RawData_setInt< uint8_t >( Helper::RawDataSpan{}, 0x01 ), std::out_of_range );
}
...
BOOST_AUTO_TEST_CASE( setInt8LittleEndianTest )
{
  ...
  const auto retData{ RawData_setInt< uint8_t >( data, 0x01, boost::endian::order::little ) } ;
  BOOST_CHECK( retData.empty() );
  BOOST_CHECK( std::ranges::equal( data, RawData_asRawData( std::to_array< uint8_t >( { 0x01 } ) ) ) );
...
BOOST_AUTO_TEST_CASE( setInt16BigEndianTest )
{
  ...
  const auto retData{ RawData_setInt< uint16_t >( data, 0x0123, boost::endian::order::big ) } ;
  BOOST_CHECK( retData.empty() );
  BOOST_CHECK( std::ranges::equal( data, RawData_asRawData( std::to_array< uint8_t >( { 0x01, 0x23 } ) ) ) );

  BOOST_CHECK_THROW( RawData_setInt< uint16_t >( Helper::RawDataSpan{}, 0x01 ), std::out_of_range );
}
...
BOOST_AUTO_TEST_CASE( setInt16BigLittleTest )
{
  ...
  const auto retData{ RawData_setInt< uint16_t >( data, 0x0123, boost::endian::order::little ) } ;
  BOOST_CHECK( retData.empty() );
...
BOOST_AUTO_TEST_CASE( setInt32BigEndianTest )
{
  ...
  const auto retData{ RawData_setInt< uint32_t >( data, 0x0123'4567, boost::endian::order::big ) } ;
  BOOST_CHECK( retData.empty() );
  BOOST_CHECK(
    std::ranges::equal(
      data,
  ...
  BOOST_CHECK_THROW( RawData_setInt< uint32_t >( Helper::RawDataSpan{}, 0x01 ), std::out_of_range );
}
...
BOOST_AUTO_TEST_CASE( setInt32LittleEndianTest )
{
  ...
  const auto retData{ RawData_setInt< uint32_t >( data, 0x0123'4567, boost::endian::order::little ) } ;
  BOOST_CHECK( retData.empty() );
  BOOST_CHECK(
    std::ranges::equal(
      data,
...
BOOST_AUTO_TEST_CASE( setInt64BigEndianTest )
{
  ...
  const auto retData{ RawData_setInt< uint64_t >( data, 0x0123'4567'89AB'CDEF, boost::endian::order::big ) } ;
  BOOST_CHECK( retData.empty() );
  BOOST_CHECK(
    std::ranges::equal(
      data,
  ...
  BOOST_CHECK_THROW( RawData_setInt< uint64_t >( Helper::RawDataSpan{}, 0x01 ), std::out_of_range );
}
...
BOOST_AUTO_TEST_CASE( setInt64LittleEndianTest )
{
  ...
  const auto retData{ RawData_setInt< uint64_t >( data, 0x0123'4567'89AB'CDEF, boost::endian::order::little ) } ;
  BOOST_CHECK( retData.empty() );
  BOOST_CHECK(
    std::ranges::equal(
      data,
