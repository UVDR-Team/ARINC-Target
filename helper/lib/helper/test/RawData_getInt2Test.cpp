 ...
 *
 * @brief Definition of Unit Tests for Helper::RawData_getInt Operations.
 **/
...
BOOST_AUTO_TEST_SUITE( RawData_getInt2Test )
...
BOOST_AUTO_TEST_CASE( getInt8BigEndianTest )
{
  ...
  uint8_t value{};
  std::tie( data, value ) = RawData_getInt< uint8_t > ( data, boost::endian::order::big );
  ...
  BOOST_CHECK_THROW(
    boost::ignore_unused( RawData_getInt< uint8_t >( Helper::ConstRawDataSpan{}, boost::endian::order::big ) ),
    std::out_of_range );
}
...
BOOST_AUTO_TEST_CASE( getInt8LittleEndianTest )
{
  ...
  uint8_t value{};
  std::tie( data, value ) = RawData_getInt< uint8_t > ( data, boost::endian::order::little );
  BOOST_CHECK( value == 0x01 );
  BOOST_CHECK( data.size() == rawDataSpan.size() - 1 );
  ...
  BOOST_CHECK_THROW(
    boost::ignore_unused( RawData_getInt< uint8_t >( Helper::ConstRawDataSpan{}, boost::endian::order::little ) ),
    std::out_of_range );
}
...
BOOST_AUTO_TEST_CASE( getInt16BigEndianTest )
{
  ...
  uint16_t value{};
  std::tie( data, value ) = RawData_getInt< uint16_t > ( data, boost::endian::order::big );
  ...
  BOOST_CHECK_THROW(
    boost::ignore_unused( RawData_getInt< uint16_t >( Helper::ConstRawDataSpan{}, boost::endian::order::big ) ),
    std::out_of_range );
}
...
BOOST_AUTO_TEST_CASE( getInt16LittleEndianTest )
{
  ...
  uint16_t value{};
  std::tie( data, value ) = RawData_getInt< uint16_t > ( data, boost::endian::order::little );
  ...
  BOOST_CHECK_THROW(
    boost::ignore_unused( RawData_getInt< uint16_t >( Helper::ConstRawDataSpan{}, boost::endian::order::little ) ),
    std::out_of_range );
}
...
BOOST_AUTO_TEST_CASE( getInt32BigEndianTest )
{
  ...
  uint32_t value{};
  std::tie( data, value ) = RawData_getInt< uint32_t > ( data, boost::endian::order::big );
  ...
  BOOST_CHECK_THROW(
    boost::ignore_unused( RawData_getInt< uint32_t >( Helper::ConstRawDataSpan{}, boost::endian::order::big ) ),
    std::out_of_range );
}
...
BOOST_AUTO_TEST_CASE( getInt32BigLittleTest )
{
  ...
  uint32_t value{};
  std::tie( data, value ) = RawData_getInt< uint32_t > ( data, boost::endian::order::little );
  ...
  BOOST_CHECK_THROW(
    boost::ignore_unused( RawData_getInt< uint32_t >( Helper::ConstRawDataSpan{}, boost::endian::order::little ) ),
    std::out_of_range );
}
...
BOOST_AUTO_TEST_CASE( getInt64BigEndianTest )
{
  ...
  uint64_t value{};
  std::tie( data, value ) = RawData_getInt< uint64_t > ( data, boost::endian::order::big );
  ...
  BOOST_CHECK_THROW(
    boost::ignore_unused( RawData_getInt< uint64_t >( Helper::ConstRawDataSpan{}, boost::endian::order::big ) ),
    std::out_of_range );
}
...
BOOST_AUTO_TEST_CASE( getInt64BigLittleTest )
{
  ...
  uint64_t value{};
  std::tie( data, value ) = RawData_getInt< uint64_t > ( data, boost::endian::order::little );
  ...
  BOOST_CHECK_THROW(
    boost::ignore_unused( RawData_getInt< uint64_t >( Helper::ConstRawDataSpan{}, boost::endian::order::little ) ),
    std::out_of_range );
}
