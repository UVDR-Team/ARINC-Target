 ...
 * @sa @ref RawData_asRaw(std::string_view)
 **/
[[nodiscard]] constexpr std::string_view RawData_asString( ConstRawDataSpan raw );
 ...
 * @sa @ref RawData_asRaw(std::string_view)
 **/
[[nodiscard]] constexpr std::string_view RawData_asString( ConstRawDataSpan raw, std::size_t stringLength );
