...
void InformationOperationConfiguration::fromProperties( const boost::property_tree::ptree &properties )
{
  ...
  listCheckValue = Arinc649::CheckValueTypeDescription::instance().enumeration(
...
boost::property_tree::ptree InformationOperationConfiguration::toProperties( const bool full ) const
{
  ...
  if ( full || ( listCheckValue != Arinc649::CheckValueType::NotUsed ) )
  {
    properties.add( "list_check_value", Arinc649::CheckValueTypeDescription::instance().name( listCheckValue ) );
  }
