...
void DownloadOperationConfiguration::fromProperties( const boost::property_tree::ptree &properties )
{
  ...
  checksumOption = Arinc649::CheckValueTypeDescription::instance()
...
boost::property_tree::ptree DownloadOperationConfiguration::toProperties( const bool full ) const
{
  ...
  if ( full || ( Arinc649::CheckValueType::NotUsed != checksumOption ) )
  {
    properties.add( "checksum_option", Arinc649::CheckValueTypeDescription::instance().name( checksumOption ) );
  }
