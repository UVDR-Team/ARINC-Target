...
/**
 * @brief Set the logging level for the TFTP Library.
 *
 * Adjusts the verbosity of log messages generated by the TFTP Library.
 *
 * @param level Logging level to be set.
 *   The level defines the granularity of log messages.
 **/
TFTP_EXPORT void setLogLevel( spdlog::level::level_enum level );
