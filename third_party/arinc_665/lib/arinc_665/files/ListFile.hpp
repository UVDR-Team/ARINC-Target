...
class ARINC_665_EXPORT ListFile : public Arinc665File
{
  ...
  protected:
    ...
    //! @copydoc Arinc665File::Arinc665File(ArincSupport::ConstRawDataSpan,FileType,ptrdiff_t)
    ListFile(
     ...
     **/
    [[nodiscard]] ArincSupport::RawData encodeMediaInformation() const;
     ...
     *   Raw Data
     **/
    void decodeMediaInformation( ArincSupport::ConstRawDataSpan rawData );
