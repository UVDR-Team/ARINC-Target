 ...
 **/
[[nodiscard]] ARINC_665_EXPORT size_t CheckValueUtils_size( ArincChecksum::CheckValueType type );
 ...
 **/
[[nodiscard]] ARINC_665_EXPORT ArincSupport::RawData CheckValueUtils_encode( const ArincChecksum::CheckValue &checkValue );
 ...
 **/
[[nodiscard]] ARINC_665_EXPORT ArincChecksum::CheckValue CheckValueUtils_decode( ArincSupport::ConstRawDataSpan rawFile );
