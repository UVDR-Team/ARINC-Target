...
class ARINC_665_EXPORT LoadHeaderFile final : public Arinc665File
{
  public:
     ...
     *   Processed CRC state.
     **/
    static void processLoadCrc( ArincSupport::ConstRawDataSpan rawFile, ArincChecksum::Arinc645Crc32 &loadCrc );
     ...
     *   Load CRC
     **/
    static void encodeLoadCrc( ArincSupport::RawDataSpan rawFile, uint32_t crc );
     ...
     * @return Load CRC
     **/
    [[nodiscard]] static uint32_t decodeLoadCrc( ArincSupport::ConstRawDataSpan rawFile );
     ...
     *   Load Check Value
     **/
    static void encodeLoadCheckValue( ArincSupport::RawDataSpan rawFile, const ArincChecksum::CheckValue &checkValue );
     ...
     * @retval ArincChecksum::NoCheckValue
     *   When no Load Check Value is stored.
     **/
    [[nodiscard]] static ArincChecksum::CheckValue decodeLoadCheckValue( ArincSupport::ConstRawDataSpan rawFile );
     ...
     **/
    explicit LoadHeaderFile( ArincSupport::ConstRawDataSpan rawFile );

    //! Destructor.
    ~LoadHeaderFile() override = default;

    //! @copydoc Arinc665File::operator=
    LoadHeaderFile& operator=( ArincSupport::ConstRawDataSpan rawFile ) override;
     ...
     *
     * The part flags exist since ARINC 665-3.
     ...
     *
     * Each _Load Header File_ (Load) shall have a unique _Part Number_.
     * @{
     **/
     ...
     **/
    [[nodiscard]] ArincChecksum::CheckValueType loadCheckValueType() const;
     ...
     **/
    void loadCheckValueType( ArincChecksum::CheckValueType type );
  ...
  private:
     ...
     *
     * @return Raw representation of the files information list.
     **/
    [[nodiscard]] ArincSupport::RawData encodeDataFiles( bool encodeV3Data ) const;
     ...
     * @return Raw representation of the files information list.
     **/
    [[nodiscard]] ArincSupport::RawData encodeSupportFiles( bool encodeV3Data ) const;
     ...
     **/
    void decodeDataFiles( ArincSupport::ConstRawDataSpan rawData, bool decodeV3Data );
     ...
     *   If set to true, additional data as stated in ARINC 665-3 is decoded.
     **/
    void decodeSupportFiles( ArincSupport::ConstRawDataSpan rawData, bool decodeV3Data );
    ...
    //! generation.
    ArincChecksum::CheckValueType loadCheckValueTypeV{ ArincChecksum::CheckValueType::NotUsed };
};
