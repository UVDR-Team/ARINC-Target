 ...
 **/
ARINC_665_EXPORT std::tuple< ArincSupport::ConstRawDataSpan, std::string_view > StringUtils_decodeString(
 ...
 **/
[[nodiscard]] ARINC_665_EXPORT ArincSupport::RawData StringUtils_encodeString( std::string_view string );
 ...
 **/
ARINC_665_EXPORT std::tuple< ArincSupport::ConstRawDataSpan, std::list< std::string > > StringUtils_decodeStrings(
  ArincSupport::ConstRawDataSpan rawData );
 ...
 **/
[[nodiscard]] ARINC_665_EXPORT ArincSupport::RawData StringUtils_encodeStrings( const std::list< std::string > &strings );
