...
class ARINC_665_EXPORT FileListFile final : public ListFile
{
  public:
     ...
     **/
    explicit FileListFile( ArincSupport::ConstRawDataSpan rawFile );

    //! Destructor.
    ~FileListFile() override = default;

    //! @copydoc ListFile::operator=(ArincSupport::ConstRawDataSpan)
    FileListFile& operator=( ArincSupport::ConstRawDataSpan rawFile ) override;
     ...
     * @return Check Value.
     **/
    [[nodiscard]] ArincChecksum::CheckValueType checkValueType() const;
     ...
     *   Check Value Type.
     **/
    void checkValueType( ArincChecksum::CheckValueType type );
  ...
  private:
     ...
     **/
    [[nodiscard]] ArincSupport::RawData encodeFilesInfo( bool encodeV3Data ) const;
     ...
     **/
    void decodeFilesInfo( ArincSupport::ConstRawDataSpan rawData, bool decodeV3Data );
    ...
    ArincChecksum::CheckValueType checkValueTypeV{ ArincChecksum::CheckValueType::NotUsed };
};
