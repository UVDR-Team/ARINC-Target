...
{
  LoadFileInfo loadFileInfo{ "NAME", "PART_NUMBER", 0xDEADBEEFUL, 0xBABEU, ArincChecksum::CheckValue::NoCheckValue };
  ...
  BOOST_CHECK( loadFileInfo.checkValue == ArincChecksum::CheckValue::NoCheckValue );
}
...
BOOST_AUTO_TEST_CASE( GetSetCheckValue)
{
  ...
  BOOST_CHECK_NO_THROW(
    ( loadFileInfo.checkValue = ArincChecksum::CheckValue{
