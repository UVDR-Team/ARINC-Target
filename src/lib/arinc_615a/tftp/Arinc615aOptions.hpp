...
struct ARINC_615A_EXPORT Arinc615aOptions
{
  ...
  //! Checksum Option
  ArincChecksum::CheckValue checksum;
  ...
  {
    return port || !partNumber.empty() || ( ArincChecksum::CheckValueType::NotUsed != checksum.type() );
  }
 ...
 * @return Returns the option name.
 **/
[[nodiscard]] ARINC_615A_EXPORT std::string_view Arinc615aOptions_name( ArincChecksum::CheckValueType type ) noexcept;
 ...
 *
 * The @p std::pair< bool, ArincChecksum::CheckValue > is used to indicate if the checksum option processing was successful
 ...
 **/
[[nodiscard]] ARINC_615A_EXPORT std::pair< bool, ArincChecksum::CheckValue > Arinc615aOptions_checksum(
