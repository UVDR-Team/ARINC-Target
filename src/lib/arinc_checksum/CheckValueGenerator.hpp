 ...
 *
 * @brief Declaration of Class ArincChecksum::CheckValueGenerator.
 **/

#ifndef ARINC_645_ARINC645_CHECKVALUEGENERATOR_HPP
#define ARINC_645_ARINC645_CHECKVALUEGENERATOR_HPP
...
/**
 * @brief ARINC 645 Check Value Generator.
 *
 * This class encapsulates various check value generators, which are defined by ARINC 645.
 *
 * @sa @ref CheckValueGenerator::create()
 **/
class ARINC_645_EXPORT CheckValueGenerator
{
  public:
    //! Destructor
     ...
     **/
    [[nodiscard]] static std::optional< CheckValue > checkValue( CheckValueType type, ArincSupport::ConstRawDataSpan data );

    /**
     * @brief Calculates an ARINC 645 Check Value of a given file.
     *
     * @param[in] file
     *   Filename
     ...
     * @sa @ref CheckValueGenerator::checkValue()
     **/
    virtual void process( ArincSupport::ConstRawDataSpan data ) = 0;
