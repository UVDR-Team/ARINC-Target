 ...
 **/
[[nodiscard]] ARINC_665_EXPORT ArincSupport::VersionsInformation::value_type arinc665Version();
 ...
 **/
ARINC_665_EXPORT void setLogLevel( ArincSupport::Logging::level::level_enum level );
