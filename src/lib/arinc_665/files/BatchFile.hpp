...
class ARINC_665_EXPORT BatchFile final : public Arinc665File
{
  public:
     ...
     **/
    explicit BatchFile( ArincSupport::ConstRawDataSpan rawFile );

    //! Destructor.
    ~BatchFile() override = default;

    //! @copydoc Arinc665File::operator=
    BatchFile& operator=( ArincSupport::ConstRawDataSpan rawFile ) override;
  ...
  private:
     ...
     **/
    [[nodiscard]] ArincSupport::RawData encodeBatchTargetsInfo() const;
     ...
     **/
    void decodeBatchTargetsInfo( ArincSupport::ConstRawDataSpan rawData );
