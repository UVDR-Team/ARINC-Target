...
ReadRequestPacket::ReadRequestPacket( ArincSupport::ConstRawDataSpan rawPacket ) :
  ReadWriteRequestPacket( PacketType::ReadRequest, rawPacket )
{
}

ReadRequestPacket& ReadRequestPacket::operator=( ArincSupport::ConstRawDataSpan rawPacket )
{
