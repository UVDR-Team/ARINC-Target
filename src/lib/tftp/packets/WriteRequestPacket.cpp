...
WriteRequestPacket::WriteRequestPacket( ArincSupport::ConstRawDataSpan rawPacket ) :
  ReadWriteRequestPacket{ PacketType::WriteRequest, rawPacket }
{
}

WriteRequestPacket& WriteRequestPacket::operator=( ArincSupport::ConstRawDataSpan rawPacket )
{
