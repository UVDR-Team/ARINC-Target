...
class TFTP_EXPORT PacketTypeDescription final : public ArincSupport::Description< PacketTypeDescription, PacketType >
{
  public:
 ...
 **/
TFTP_EXPORT std::ostream& operator<<( std::ostream& stream, PacketType packetType );
