...
class TFTP_EXPORT WriteRequestPacket final : public ReadWriteRequestPacket
{
  public:
     ...
     **/
    WriteRequestPacket( std::string filename, TransferMode mode, Options options ) noexcept;
     ...
     **/
    explicit WriteRequestPacket( ArincSupport::ConstRawDataSpan rawPacket );
     ...
     * @return @p *this
     **/
    WriteRequestPacket& operator=( ArincSupport::ConstRawDataSpan rawPacket );
};
