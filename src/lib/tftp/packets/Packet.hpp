...
class TFTP_EXPORT Packet
{
  public:
     ...
     **/
    [[nodiscard]] static PacketType packetType( ArincSupport::ConstRawDataSpan rawPacket );
  ...
  protected:
     ...
     **/
    Packet( PacketType packetType, ArincSupport::ConstRawDataSpan rawPacket );
     ...
     **/
    void insertHeader( ArincSupport::RawDataSpan rawPacket ) const;
     ...
     *   Packet, which shall be decoded.
     **/
    void decodeHeader( ArincSupport::ConstRawDataSpan rawPacket );

  private:
    //! TFTP Packet Type
    const PacketType packetTypeV;
};
