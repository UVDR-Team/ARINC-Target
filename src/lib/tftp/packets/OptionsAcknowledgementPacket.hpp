...
class TFTP_EXPORT OptionsAcknowledgementPacket final : public Packet
{
  public:
     ...
     **/
    explicit OptionsAcknowledgementPacket( ArincSupport::ConstRawDataSpan rawPacket );
     ...
     * @return *this
     **/
    OptionsAcknowledgementPacket& operator=( ArincSupport::ConstRawDataSpan rawPacket );
