...
class OperationImpl : protected Packets::PacketHandler
{
  protected:
     ...
     **/
    void invalidPacket( const boost::asio::ip::udp::endpoint &remote, ArincSupport::ConstRawDataSpan rawPacket ) final;
  ...
  private:
    ...
    ArincSupport::RawData receivePacketV;
    ...
    ArincSupport::RawData transmitPacketV;
