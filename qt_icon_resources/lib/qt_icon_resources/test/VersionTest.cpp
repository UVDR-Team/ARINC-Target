 ...
 *
 * @brief Definition of Unit Tests for Class QtIconResources::Version.
 **/
...
BOOST_AUTO_TEST_SUITE( QtIconResourcesTest )
...
BOOST_AUTO_TEST_CASE( version )
{
  ...
  BOOST_TEST_MESSAGE( "Qt Icon Resources  Version Information: " << Version::VersionInformation );
}
