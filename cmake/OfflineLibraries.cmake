...
function(arinc_configure_support source_root)
  ...
  set(ARINC_BOOST_INCLUDE_DIR "" CACHE PATH "Optional override for the bundled Boost 1.88 headers")
  if(NOT ARINC_BOOST_INCLUDE_DIR)
    include("${source_root}/cmake/BundledBoost.cmake")
    arinc_extract_boost("${source_root}" "${CMAKE_BINARY_DIR}/bundled-boost")
    set(ARINC_BOOST_INCLUDE_DIR "${CMAKE_BINARY_DIR}/bundled-boost" CACHE PATH "Boost headers" FORCE)
  endif()
  ...
  target_compile_features(arinc_build_config INTERFACE cxx_std_20)
  target_compile_definitions(arinc_build_config INTERFACE BOOST_ASIO_NO_DEPRECATED BOOST_ALL_NO_LIB
    ARINC_ENABLE_COMMAND_LINE=$<BOOL:${ARINC_ENABLE_COMMAND_LINE}>)
  if(CMAKE_SYSTEM_NAME STREQUAL "VxWorks")
    target_compile_options(arinc_build_config INTERFACE
      "SHELL:-include arinc_support/BuildConfig.hpp")
  endif()
  ...
  if(ARINC_ENABLE_COMMAND_LINE)
    ...
    elseif(boost_version EQUAL 108800)
      ...
      target_compile_features(arinc_cli_options PRIVATE cxx_std_20)
